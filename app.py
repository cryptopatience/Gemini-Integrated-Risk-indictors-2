...
st.caption("""신용 지표(연체율, 스프레드)는 '후행 지표' 성격이 강합니다. 실물 경제 차입자들의 상환 능력을 반영.기업이나 가계가 자금난을 겪고 실제로 부도가 나기까지는 시간이 걸립니다. 
현재 연체율이 낮다는 것은 '과거'에 조달한 자금으로 아직 버티고 있다는 뜻일 뿐, 미래의 안정성을 보장하지 않습니다. 신용 지표: 과거 3-6개월의 경제 상황을 반영 (backward-looking)
연체율: 12-18개월 지연 지표 """)
